...
EXT_LIB_DIR=$DEPLOY_DIR/ext
EXT_LIB_JARS=`ls $EXT_LIB_DIR|grep .jar|awk '{print "'$EXT_LIB_DIR'/"$0}'|tr "\n" ":"`
...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS:$EXT_LIB_JARS com.dev.netty.http.server.HttpServer > $STDOUT_FILE 2>&1 &
